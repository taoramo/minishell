...
SRCS = $(addprefix srcs/, $(addprefix shell/, main.c parse_parentheses.c expand_supergroups.c minishell_vec_utils.c ft_is_inside.c signal.c signal2.c error.c handle_pipelines.c syntax_parenth.c syntax_other.c syntax_andor.c here_doc.c here_doc_input.c) \
