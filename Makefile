...
SRCS = $(addprefix srcs/, $(addprefix shell/, main.c parse_parentheses.c expand_supergroups.c minishell_vec_utils.c ft_is_inside.c signal.c signal2.c error.c handle_pipelines.c syntax_check.c syntax_check2.c syntax_check3.c here_doc.c here_doc_input.c) \
